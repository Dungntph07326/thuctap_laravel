            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="product__details__text">
                        ...
                        <a href="#" class="primary-btn add_to_cart" data-url="{{route('addToCart',['id' => $product->id])}}">ADD TO CARD</a>
            ...
            @foreach($list as $cat)
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="product__item">
                        <div class="product__item__pic set-bg" data-setbg="{{$cat->image}}">
                        ...
                        <div class="product__item__text">
                            <h6><a href="{{route('pro.show',['id'=> $product->id])}}">{{$cat->name}}</a></h6>
                            <h5>{{$cat->price}}</h5>
                        </div>
                    </div>
                </div>
